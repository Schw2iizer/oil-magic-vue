<template lang="html">
    <div class="favorite-product-wrapper">
        <div id="content">
          <section class="sub-banner" style="background:url(/images/favorite-products.jpg)  no-repeat; background-size: 100% auto">
            <div class="container">
            ...
            <div class="container">
              <div class="relative">
                ...
                <p>The Family Essentials Kit is a collection of ten nurturing essential oils, including six single oils and four blends. <br>
                    ...
                    This kit includes 5 mL Essential Oils: Lavender, Lemon, Peppermint, Melaleuca, Oregano, Frankincense, Deep Blue®, Breathe, DigestZen®, and On Guard to help families address a multitude of health issues.

                    We use and go to these oils daily for all of our family’s basic needs!
                </p>
                <hr>
                <div class="heading-block no-margin-bottom">
