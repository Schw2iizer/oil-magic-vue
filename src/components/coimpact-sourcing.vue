<template lang="html">
    <div class="coimpact-wrapper">
        <div id="content">
          <section class="sub-banner" style="background:url(images/why-doterra.jpg) fixed no-repeat center; background-size: 100% auto">
            <div class="container">
              <div class="position-center-center">
                <h2 class="white">Co-Impact Sourcing</h2>
              </div>
            </div>
          </section>
            ...
            <div class="container">
              <div class="relative">
                ...
                <div class="padding-top-20 youtube-wrapper">
                    <iframe width="600" height="400" src="https://www.youtube.com/embed/Q70EFAddZdI" frameborder="0" allowfullscreen></iframe>
                </div>
              </div>
            </div>
          </section>
