               ...
               <li class="col-md-3">
                 <div class="team-image">
                   ...
                   <ul class="social-icons text-center">
                     ...
                     <li><a href="mailto:kellihunter008@gmail.com"><i class="fa fa-envelope"></i></a></li>
                   </ul>
                   <div class="member-detail">
                     <h6>Kelli Hunter</h6>
                ...
                <li class="col-md-3">
                    <div class="team-image">
                      ...
                      <ul class="social-icons text-center">
                        ...
                        <li><a href="http://www.soulfilledyogi.com"><i class="fa fa-newspaper-o"></i></a></li>
                        <li><a href="http://www.sacredbizsuccess.com/"><i class="fa fa-newspaper-o"></i></a></li>
                      </ul>
                      <div class="member-detail">
                ...
                <li class="col-md-3">
                  <div class="team-image">
                    ...
                    <ul class="social-icons text-center">
                      ...
                      <li><a href="tel:4177666643"><i class="fa fa-phone"></i></a></li>
                      <li><a href="mailto:bluebirdessentialoils@gmail.com"><i class="fa fa-envelope"></i></a></li>
                    </ul>
                    <div class="member-detail">
                      <h6>Karman Petersen</h6>
                      <span class="font-crimson font-italic">Premiere Leader from Missouri</span> </div>
                  </div>
                </li>
                <li class="col-md-3">
                  <div class="team-image">
